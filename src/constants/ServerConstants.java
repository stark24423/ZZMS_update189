...
public class ServerConstants {
    ...
    public static short MAPLE_VERSION = (short) 189;
...
;
    ...
    public static boolean REDIRECTION = true; // 退出遊戲返回選角界面開關
    ...
    public static final byte[] getGateway_IP() {
        try {
            final InetAddress ineptAdar = InetAddress.getByName(ServerConfig.IP);
            return ineptAdar.getAddress();
        } catch (Exception e) {
            return new byte[]{(byte) 221, (byte) 231, (byte) 130, (byte) 70};
        }
    }
    ...
    public static void loadSetting() {
        ...
        REDIRECTION = ServerProperties.getProperty("REDIRECTION", REDIRECTION);
